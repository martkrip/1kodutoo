...
const body = document.body; // Reference to the body for changing background
...
uploadImage.addEventListener("change", (e) => {
    if (e.target.files && e.target.files[0]) {
        ...
        body.style.backgroundSize = "cover"; // Make sure the image covers the whole page
        body.style.backgroundPosition = "center"; // Center the background
        body.style.backgroundRepeat = "no-repeat"; // Ensure it doesn't repeat
    }
});
